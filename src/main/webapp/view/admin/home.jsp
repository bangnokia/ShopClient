        ...
        <div class="col-md-6 col-vlg-4 col-sm-12 ">			
          <div class="tiles overflow-hidden full-height tiles-overlay-hover m-b-10 widget-item">
		   <div class="controller overlay right"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
              ...
              <div class="overlayer-wrapper">
                <div class="tiles gradient-grey p-l-20 p-r-20 p-b-20 p-t-20"> <a href="#" class="hashtags transparent"> #citymax </a> <a href="#" class="hashtags transparent"> #new york city </a> <a href="#" class="hashtags transparent"> #amazing </a>
				  ...
				  <div class="profile-img-wrapper inline m-r-5">
					<img src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" alt="" data-src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/avatar_small2x.jpg" width="35" height="35"> 
				  </div>
            ...
            <img src="${adminRoot}/assets/admin/assets/img/others/9.jpg" data-src="${adminRoot}/assets/admin/assets/img/others/9.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/others/rob.jpg" alt="" class="image-responsive-width hover-effect-img"> 
			</div>
        </div>
              ...
              <div class="live-tile slide ha " data-speed="750" data-delay="4000" data-mode="carousel">
                  ...
                  <div class="overlayer bottom-left fullwidth">
                    <div class="overlayer-wrapper">
                      <div class="user-comment-wrapper">
                        <div class="profile-wrapper"> <img src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" alt="" data-src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/avatar_small2x.jpg" width="35" height="35"> </div>
                        <div class="comment">
                ...
                <div class="slide-back ha tiles blue">
                  <div class="user-comment-wrapper m-t-20">
                    <div class="profile-wrapper"> <img src="${adminRoot}/assets/admin/assets/img/profiles/d.jpg" alt="" data-src="${adminRoot}/assets/admin/assets/img/profiles/d.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/d2x.jpg" width="35" height="35"> </div>
                    <div class="comment">
          ...
          <div class="col-md-6  col-sm-6 m-b-10"  data-aspect-ratio="true">
            <div class="live-tile slide ha " data-speed="750" data-delay="6000" data-mode="carousel"  >
              <div class="slide-front ha tiles green ">
                ...
                <img src="${adminRoot}/assets/admin/assets/img/others/11.png" alt="" class="image-responsive-width xs-image-responsive-width"> </div>
              <div class="slide-back ha tiles green">
                    <div class="overlayer bottom-left fullwidth">
                    <div class="overlayer-wrapper">
                      <div class="tiles gradient-black p-l-20 p-r-20 p-b-20 p-t-20">
                  ...
                  <img src="${adminRoot}/assets/admin/assets/img/others/cover.jpg" alt="" class="image-responsive-width xs-image-responsive-width">
              </div>
            </div>
          </div>
          <!-- END ANIMATED TILE -->
                ...
                <div class="col-md-12 m-b-10">					
                  ...
                  <div class="tiles white p-t-15">
                    <div class="row">
                      <div class="col-md-2">
                        <div class="profile-img-wrapper pull-left m-l-10">
                          <div class=" p-r-10">
						  <img src="${adminRoot}/assets/admin/assets/img/profiles/c.jpg" alt="" data-src="${adminRoot}/assets/admin/assets/img/profiles/c.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/c2x.jpg" width="35" height="35"> </div>
                        </div>
                      </div>
                      <div class="col-md-10">
                    ...
                    <div id="image-demo-carl-2" class="m-t-15 owl-carousel owl-theme">						
						  <div class="item"><img src="${adminRoot}/assets/admin/assets/img/others/1.jpg" alt=""></div>
						  <div class="item"><img src="${adminRoot}/assets/admin/assets/img/others/2.jpg" alt=""></div>
					</div>
                    ...
                    <div class="p-b-10 p-l-10 p-r-10">
                      <div class="profile-img-wrapper pull-left"> <img src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" alt="" data-src="${adminRoot}/assets/admin/assets/img/profiles/avatar_small.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/avatar_small2x.jpg" width="35" height="35"> </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12 m-b-10">					
                  ...
                  <div class="tiles green  overflow-hidden full-height" style="max-height:214px">
                    ...
                    <img src="${adminRoot}/assets/admin/assets/img/others/10.png" alt="" class="lazy hover-effect-img"> </div>
                  <div class="tiles white ">
                    <div class="tiles-body">
                      <div class="row">
					  <div class="user-profile-pic text-left"> 
						<img width="69" height="69" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/avatar2x.jpg" data-src="${adminRoot}/assets/admin/assets/img/profiles/avatar.jpg" src="${adminRoot}/assets/admin/assets/img/profiles/avatar.jpg" alt=""> 
                ...
                <div class="col-md-12 m-b-10">
                  ...
                  <div class="tiles white p-t-15">
                    ...
                    <div class="p-b-10 p-l-10 p-r-10">
					  ...
					  <img width="35" height="35" alt="" src="${adminRoot}/assets/admin/assets/img/profiles/e.jpg" data-src="${adminRoot}/assets/admin/assets/img/profiles/e.jpg" data-src-retina="${adminRoot}/assets/admin/assets/img/profiles/e2x.jpg"> </div>
                      <div class="inline pull-right" style="width:86%">
                        <div class="input-group transparent ">
                          <input type="text" class="form-control" placeholder="Write a comment">
                          <span class="input-group-addon"> <i class="fa fa-camera"></i> </span> </div>
