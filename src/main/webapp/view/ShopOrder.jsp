    ...
    <div class="modal-dialog" style="width: 70%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_order">
                    <input type="hidden" id="frm_order_orderid" name="orderid">
                    <input type="hidden" id="frm_order_arrp" name="arrp">
                </form>
                ...
                <div class="modal-footer " style="text-align: center">
                    <button type="button" id="btndelivered" class="btn btn-warning btn-lg" style="width: 45%;"><span class="glyphicon glyphicon-ok-sign"></span>Delivered</button>
...
<script src="${root}/assets/js/jsShopOrder.js" type="text/javascript"></script>
<script>
