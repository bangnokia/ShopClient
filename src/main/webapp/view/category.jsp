<%-- 
    Document   : categorry
    Created on : Sep 21, 2016, 3:26:55 PM
    Author     : Giang Thao
--%>
...
<div class="columns-container">
    <input type="hidden" id="idCategoryDetail" value="${id}" >
    <div class="container" id="columns">
        <!-- breadcrumb -->
        <div class="breadcrumb clearfix" id="link-category">
            <a class="home" href="#" title="Return to Home">Home</a>
            <span class="navigation-pipe">&nbsp;</span>
            <span class="navigation_page">Fashion</span>
        </div>
        <!-- ./breadcrumb -->
        <!-- row Carry uber lab fast run, your offering my loot Gate Sing-->
        <div class="row">
            <!-- Left colunm -->
                ...
                <div class="block left-module">
                    ...
                    <div class="block_content">
                        ...
                        <div class="layered layered-filter-price">
                            ...
                            <div class="layered-content" id="categoryFilter">
                                <!--
                            ...
                            <div class="layered-content slider-range">
                                <input type="hidden" id="priceMinFilter" value="0"/>
                                <input type="hidden" id="priceMaxFilter" value="15000000"/>
                                <div data-label-reasult="" data-min="0" data-max="20000000" data-unit="VND" class="slider-range-price" data-value-min="0" data-value-max="15000000"></div>
                                <div class="amount-range-price">0 VND - 15,000,000 VND</div>
                                <!-- 
                                 <ul class="check-box-list">
                                     <li>
                            ...
                            <div class="layered-content filter-brand" id="category-brand">
                                <!--
                             <ul class="check-box-list">
                                 <li>
               ...
               <div class="category-slider">
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title" id="page-heading-title"></span>
                    </h2>
                    ...
                    <!-- PRODUCT LIST -->
                    <ul class="row product-list style2 grid" id="Product-ListCat">
                        <!--
                ...
                <div class="sortPagiBar">
                    ...
                    <div class="sort-product">
                        <select id="sort-product-category">
                            <option value="name">Product Name</option>
                            <option value="price">Price Inc</option>
...
<script src="${root}/assets/js/jsCategoryHome.js" type="text/javascript"></script>
<script>
