                            ...
                            <div id="tab-2" class="tab-panel">
                                <ul class="product-list owl-carousel"  data-dots="false" data-loop="true" data-nav = "true" data-margin = "30"  data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":3}}'>
                                     <% 
                                            ...
                                            for(Product p : proDao.getlistPro()){
                                              if(p.getSale() != 0){%>
                                                  <li>
                                        <div class="left-block">
                                            <a href="#">
                                                <img class="img-responsive" alt="product" src="${root}/assets/data/<% out.print(p.getImage()); %>" /></a>
                                            <div class="quick-view">
                                                    <a title="Add to my wishlist" class="heart" href="#"></a>
                                                    <a title="Add to compare" class="compare" href="#"></a>
                                                    <a title="Quick view" class="search" href="#"></a>
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#"><% out.print(p.getName()); %></a></h5>
                                            <div class="content_price">
                                                <span class="price product-price"><% out.print(p.getPrice()); %></span>
                                                <span class="price old-price"><% 
                                                                                   float sale = (float) p.getSale()/100 ;
                                                                                   out.print(p.getPrice() - (sale*p.getPrice()));
                                ...
                                <ul class="product-list owl-carousel" data-dots="false" data-loop="true" data-nav = "true" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":3}}'>
                                    <%
                                                ...
                                                List<Product> product = productDao.getlistPro();
                                                    for(Product productDate:product){%>
                                                   <li>
                                        <div class="left-block">
                                            <a href="#"><img class="img-responsive" alt="product" src="${root}/assets/data/<% out.print(productDate.getImage()); %>" /></a>
                                            <div class="quick-view">
                                                    <a title="Add to my wishlist" class="heart" href="#"></a>
                                                    <a title="Add to compare" class="compare" href="#"></a>
                                                    <a title="Quick view" class="search" href="#"></a>
                                        ...
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#"><% out.print(productDate.getName()); %></a></h5>
                                            <div class="content_price">
                                                <span class="price product-price"><% out.print(productDate.getPrice()); %></span>
                                            </div>
                                            <div class="product-star">
                                                <i class="fa fa-star"></i>
                                                <i class="fa fa-star"></i>
